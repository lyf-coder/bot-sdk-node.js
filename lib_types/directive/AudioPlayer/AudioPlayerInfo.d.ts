...
declare class BasePlayerInfoContent {
   ...
   * @return Object
   */
  getData(): _AudioPlayerInfo.T100;
}
/**
 * @class BaseButton Button基础类
 */
declare class BaseButton {
  data: _AudioPlayerInfo.T101;
  /**
   * BaseButton 构造方法.
   *
 ...
 */
declare class AudioPlayerInfo extends PlayerInfo {
  /**
   * 构造方法
   *
...
declare const _AudioPlayerInfo: typeof AudioPlayerInfo;
declare namespace _AudioPlayerInfo {
  ...
  export interface T103 {
    content: _AudioPlayerInfo.T102;
  }
}
export = _AudioPlayerInfo;
