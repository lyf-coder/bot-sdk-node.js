...
declare class RecommendButton extends Button {
  /**
   * RecommendButton 构造函数.
   */
  constructor();
}
declare const _RecommendButton: typeof RecommendButton;
declare namespace _RecommendButton {
  export interface T100 {
    type: string;
    name: string;
  }
}
export = _RecommendButton;
