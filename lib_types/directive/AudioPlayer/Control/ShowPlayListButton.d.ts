...
declare class ShowPlayListButton extends Button {
  /**
   *  ShowPlayListButton 构造函数.
   */
  constructor();
}
declare const _ShowPlayListButton: typeof ShowPlayListButton;
declare namespace _ShowPlayListButton {
  export interface T100 {
    type: string;
    name: string;
  }
}
export = _ShowPlayListButton;
