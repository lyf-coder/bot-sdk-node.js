...
declare class PreviousButton extends Button {
  /**
   *  PreviousButton 构造函数.
   */
  constructor();
}
declare const _PreviousButton: typeof PreviousButton;
declare namespace _PreviousButton {
  export interface T100 {
    type: string;
    name: string;
  }
}
export = _PreviousButton;
