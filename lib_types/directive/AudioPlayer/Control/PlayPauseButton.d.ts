...
declare class PlayPauseButton extends Button {
  /**
   * PlayPauseButton 构造函数.
   */
  constructor();
}
declare const _PlayPauseButton: typeof PlayPauseButton;
declare namespace _PlayPauseButton {
  export interface T100 {
    type: string;
    name: string;
  }
}
export = _PlayPauseButton;
