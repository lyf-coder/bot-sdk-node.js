...
declare class RepeatButton extends RadioButton {
  /**
   * 构造方法 RepeatButton.
   *
   * @param {string} selectedValue 选中的选项值
...
declare const _RepeatButton: typeof RepeatButton;
declare namespace _RepeatButton {
  export interface T100 {
    type: string;
    name: string;
  }
}
export = _RepeatButton;
