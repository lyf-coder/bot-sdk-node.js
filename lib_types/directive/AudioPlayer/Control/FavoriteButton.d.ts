...
declare class FavoriteButton extends Button {
  /**
   *  FavoriteButton 构造函数.
   */
  constructor();
}
declare const _FavoriteButton: typeof FavoriteButton;
declare namespace _FavoriteButton {
  export interface T100 {
    type: string;
    name: string;
  }
}
export = _FavoriteButton;
