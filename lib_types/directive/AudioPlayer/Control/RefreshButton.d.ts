...
declare class RefreshButton extends Button {
  /**
   * RefreshButton 构造函数.
   */
  constructor();
}
declare const _RefreshButton: typeof RefreshButton;
declare namespace _RefreshButton {
  export interface T100 {
    type: string;
    name: string;
  }
}
export = _RefreshButton;
