...
declare class BaseDirective {
  data: _BaseRenderPlayerInfo.T100;
  /**
   * 构造函数
   *
...
declare class BasePlayerInfoContent {
   ...
   * @return Object
   */
  getData(): _BaseRenderPlayerInfo.T101;
}
/**
 * @class BaseButton Button基础类
 */
declare class BaseButton {
  data: _BaseRenderPlayerInfo.T102;
  /**
   * BaseButton 构造方法.
   *
...
declare const _BaseRenderPlayerInfo: typeof BaseRenderPlayerInfo;
declare namespace _BaseRenderPlayerInfo {
