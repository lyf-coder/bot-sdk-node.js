...
declare class BaseDirective {
  ...
  genToken(): string;
  getData(): _RenderAudioList.T100;
}
declare class BaseMediaListItem extends BaseDirective {
  data: _RenderAudioList.T101;
  /**
   * 构造方法
   *
...
declare class RenderAudioList extends BaseDirective {
  audioItems: any[];
  data: any;
  /**
   * 构造方法
...
declare const _RenderAudioList: typeof RenderAudioList;
declare namespace _RenderAudioList {
