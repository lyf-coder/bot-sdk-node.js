 ...
 */
declare class ListTemplate4 extends ListTemplate {
  /**
   * 构造方法
   */
  constructor();
}
declare const _ListTemplate4: typeof ListTemplate4;
declare namespace _ListTemplate4 {
