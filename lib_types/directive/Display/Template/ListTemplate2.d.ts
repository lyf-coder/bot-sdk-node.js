...
declare class ListTemplate2 extends ListTemplate {
  /**
   * ListTemplate2 构造方法.
   */
  constructor();
}
declare const _ListTemplate2: typeof ListTemplate2;
declare namespace _ListTemplate2 {
