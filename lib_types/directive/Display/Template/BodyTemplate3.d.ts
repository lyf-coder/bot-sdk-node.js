...
declare class BodyTemplate3 extends TextImageTemplate {
  /**
   * BodyTemplate3 构造方法.
   */
  constructor();
}
declare const _BodyTemplate3: typeof BodyTemplate3;
declare namespace _BodyTemplate3 {
  export interface T100 {
    type: any;
  }
}
export = _BodyTemplate3;
