...
declare class BaseDirective {
  ...
  genToken(): string;
  getData(): _TextImageTemplate.T100;
}
...
declare const _TextImageTemplate: typeof TextImageTemplate;
declare namespace _TextImageTemplate {
  export interface T100 {
    type: any;
  }
}
export = _TextImageTemplate;
