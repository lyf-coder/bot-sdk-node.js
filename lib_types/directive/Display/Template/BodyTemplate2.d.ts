...
declare class BodyTemplate2 extends TextImageTemplate {
  /**
   * BodyTemplate2 构造方法.
   */
  constructor();
}
declare const _BodyTemplate2: typeof BodyTemplate2;
declare namespace _BodyTemplate2 {
  export interface T100 {
    type: any;
  }
}
export = _BodyTemplate2;
