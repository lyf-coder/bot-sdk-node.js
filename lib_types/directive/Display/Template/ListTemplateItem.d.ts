...
declare class BaseDirective {
  ...
  genToken(): string;
  getData(): _ListTemplateItem.T100;
}
...
declare const _ListTemplateItem: typeof ListTemplateItem;
declare namespace _ListTemplateItem {
