...
declare class BodyTemplate4 extends TextImageTemplate {
  /**
   * BodyTemplate4 构造方法.
   */
  constructor();
}
declare const _BodyTemplate4: typeof BodyTemplate4;
declare namespace _BodyTemplate4 {
  export interface T100 {
    type: any;
  }
}
export = _BodyTemplate4;
