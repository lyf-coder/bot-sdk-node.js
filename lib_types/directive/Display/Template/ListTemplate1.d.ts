...
declare class ListTemplate1 extends ListTemplate {
  /**
   * ListTemplate1 构造方法.
   */
  constructor();
}
declare const _ListTemplate1: typeof ListTemplate1;
declare namespace _ListTemplate1 {
