...
declare class BaseDirective {
  ...
  genToken(): string;
  getData(): _BaseMediaListItem.T100;
}
declare class BaseMediaListItem extends BaseDirective {
  data: _BaseMediaListItem.T101;
  /**
   * 构造方法
   *
...
declare const _BaseMediaListItem: typeof BaseMediaListItem;
declare namespace _BaseMediaListItem {
