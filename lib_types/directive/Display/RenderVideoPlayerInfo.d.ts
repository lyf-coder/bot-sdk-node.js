...
declare class BaseDirective {
  data: _RenderVideoPlayerInfo.T100;
  /**
   * 构造函数
   *
...
declare class BasePlayerInfoContent {
   ...
   * @return Object
   */
  getData(): _RenderVideoPlayerInfo.T101;
}
/**
 * @class BaseButton Button基础类
 */
declare class BaseButton {
  data: _RenderVideoPlayerInfo.T102;
  /**
   * BaseButton 构造方法.
   *
 ...
 */
declare class RenderVideoPlayerInfo extends BaseRenderPlayerInfo {
  /**
   * 构造方法
   *
   * @param {BasePlayerInfoContent} content 内容
...
declare const _RenderVideoPlayerInfo: typeof RenderVideoPlayerInfo;
declare namespace _RenderVideoPlayerInfo {
