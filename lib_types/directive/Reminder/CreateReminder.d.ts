 ...
 */
declare class CreateReminder extends BaseReminder {
  constructor();
  /**
   * @desc 设置Token
   * @param {string} token
...
declare const _CreateReminder: typeof CreateReminder;
declare namespace _CreateReminder {
  export interface T100 {
    type: any;
  }
}
export = _CreateReminder;
