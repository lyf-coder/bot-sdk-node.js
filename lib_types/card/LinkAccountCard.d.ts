 ...
 * @extends {BaseCard}
 */
declare class LinkAccountCard extends BaseCard {
  /**
   * @desc 构造函数
   */
  constructor();
}
declare const _LinkAccountCard: typeof LinkAccountCard;
declare namespace _LinkAccountCard {
  export interface T100 {
    [key: string]: any;
  }
}
export = _LinkAccountCard;
