 ...
 */
declare class StandardCard extends BaseCard {
  constructor();
}
declare const _StandardCard: typeof StandardCard;
declare namespace _StandardCard {
  export interface T100 {
    [key: string]: any;
  }
}
export = _StandardCard;
